...
class OnionAttackSimulation:
    ...
    def pick_second_hops_vanguardslite_victim(self):
        ...
        all running relays weighted by bandwidth, but do NOT force at least one adversarial relay (realistic scenario)."""
...
def dump_multi_run_results(simulation_info):
    out_filename = "study-2025/data/countermeasures_logs_nol2guard/time_to_double_comp_%s_%s_%d_%0.3f.json" % (
