...
1. **`attack_time_comparison_2025.png`**  
   Box plots comparando tempos por configuração

2. **`attack_success_rate_2025.png`**  
   Bar chart mostrando taxa de sucesso (%)

3. **`attack_time_heatmap_2025.png`**  
   Heatmap 2D (guards × bandwidth)

4. **`paper_comparison_2025.png`**  
   Comparação com resultados do paper original**Resolução:** 300 DPI, profissional para relatórios
